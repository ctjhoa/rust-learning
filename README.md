...
* 2022-08-27 - [Rust vs. C in networking applications](https://www.youtube.com/watch?v=wpCUUn2recc) - Łukasz Kszonowski and Marcin Parafiniuk
...
| C/C++           | <ul><li>[Rust For Systems Programmers](https://github.com/nrc/r4cppp) & [Rust for C++ Programmers](https://www.gitbook.com/book/aminb/rust-for-c/details) - [Nick Cameron][]</li><li>[I used to use pointers - now what?](https://github.com/diwic/reffers-rs/blob/master/docs/Pointers.md) - diwic</li><li>[Comparing parallel Rust and C++](https://parallel-rust-cpp.github.io/) - matiaslindgren</li><li>[Zero cost abstractions: Rust vs C++](https://www.rottedfrog.co.uk/?p=24) - rottedfrog</li><li>[A Firehose of Rust, for busy people who know some C++](https://www.youtube.com/watch?v=IPmRDS0OSxM) - Jack O'Connor</li><li>[Rust vs. C++ — the main differences](https://codilime.com/blog/rust-vs-cpp-the-main-differences-between-these-popular-programming-languages/) - Michał Krasnoborski and Bartosz Różański</li><li>[Rust vs C: safety and performance in low-level network programming](https://codilime.com/blog/rust-vs-c-safety-and-performance-in-low-level-network-programming/) - Michał Niciejewski</li></ul> |
| Clojure         | <ul><li>[Rust for Clojurists](https://gist.github.com/oakes/4af1023b6c5162c6f8f0) - Zach Oakes</li></ul> |
| Go | <ul><li>[Rust vs Go](https://codilime.com/blog/rust-vs-go-what-do-you-need-to-know-about-these-programming-languages/) - Krzysztof Naglik</li><li>[Rust vs Go](https://bitfieldconsulting.com/golang/rust-vs-go) - John Arundel</li><li>[Rust vs. Go](http://julio.meroh.net/2018/07/rust-vs-go.html) - Julio Merino</li></ul>
...
| Python          | <ul><li>[Rust vs. Python](https://codilime.com/blog/rust-vs-python-which-would-suit-your-project-better/) - Artur Jaworski</li><li>[Rust for Python Programmers](http://lucumr.pocoo.org/2015/5/27/rust-for-pythonistas/) - Armin Ronacher</li><li>[py2rs](https://github.com/rochacbruno/py2rs) - Bruno Rocha</li></ul> |
