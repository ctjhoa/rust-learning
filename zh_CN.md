...
这是一系列的Rust学习资料，包括博客，文章，视频等等。如果你有任何链接/资源请自由添加，并提交Pull请求。

## 简介
主文档通常都有一个好的开始。如果你还没有读过，请先从 [Rust docs](http://www.rust-lang.org/).开始。你也可以读文档的 [ebook version](http://killercup.github.io/trpl-ebook/)。

*标签含义*
* [official] mozilla 工作人员在 mozilla 发表
* [old] 概念仍然有用，但是代码不能编译
* [WIP] 正在编写
...
## 视频
你可以观看Rust的聚会在[air.mozilla](https://air.mozilla.org/channels/rust/)
...
| JavaScript | <ul><li>[Rust's Ownership model for JavaScript developers](http://blog.thoughtram.io/rust/2015/05/11/rusts-ownership-model-for-javascript-developers.html) - [Christoph Burgdorf][]</li></ul> |
